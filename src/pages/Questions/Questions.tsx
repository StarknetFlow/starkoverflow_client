        ...
        <div className="questions-container mx-2">
            ...
            {isLoaded ? (
                ...
                <div>
                    ...
                    <p className='questions-title mt-4' >{question?.title}</p>
                ...
                <div>
                    ...
                    <div className='questions-footer d-flex' style={{ justifyContent: "space-between" }}>
                        ...
                        <div className='d-flex'>
                            ...
                            <div className='my-auto mx-2' onClick={() => navigate("/profile/" + question?.owner.user_id)}>
                    ...
                    <div className='question-answers-area'>
                        <div className='d-flex' style={{ justifyContent: "space-between" }}>
                            <Typography className='my-auto' variant='caption1' color='blue' fontSize="24px">{question?.answer_count === 0 ? ("No answers yet") : ("3 Answers")}</Typography>
